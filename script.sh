...
gcc mutex_case_1_thread_2.c -o mutex_case_1_thread_2 -pthread
gcc mutex_case_1_thread_4.c -o mutex_case_1_thread_4 -pthread
gcc mutex_case_1_thread_8.c -o mutex_case_1_thread_8 -pthread
gcc mutex_case_2_thread_1.c -o mutex_case_2_thread_1 -pthread
gcc mutex_case_2_thread_2.c -o mutex_case_2_thread_2 -pthread
gcc mutex_case_2_thread_4.c -o mutex_case_2_thread_4 -pthread
gcc mutex_case_2_thread_8.c -o mutex_case_2_thread_8 -pthread
gcc mutex_case_3_thread_1.c -o mutex_case_3_thread_1 -pthread
gcc mutex_case_3_thread_2.c -o mutex_case_3_thread_2 -pthread
gcc mutex_case_3_thread_4.c -o mutex_case_3_thread_4 -pthread
gcc mutex_case_3_thread_8.c -o mutex_case_3_thread_8 -pthread

gcc locks_case_1_thread_1.c -o locks_case_1_thread_1 -pthread
gcc locks_case_1_thread_2.c -o locks_case_1_thread_2 -pthread
gcc locks_case_1_thread_4.c -o locks_case_1_thread_4 -pthread
gcc locks_case_1_thread_8.c -o locks_case_1_thread_8 -pthread
gcc locks_case_2_thread_1.c -o locks_case_2_thread_1 -pthread
gcc locks_case_2_thread_2.c -o locks_case_2_thread_2 -pthread
gcc locks_case_2_thread_4.c -o locks_case_2_thread_4 -pthread
gcc locks_case_2_thread_8.c -o locks_case_2_thread_8 -pthread
gcc locks_case_3_thread_1.c -o locks_case_3_thread_1 -pthread
gcc locks_case_3_thread_2.c -o locks_case_3_thread_2 -pthread
gcc locks_case_3_thread_4.c -o locks_case_3_thread_4 -pthread
gcc locks_case_3_thread_8.c -o locks_case_3_thread_8 -pthread
